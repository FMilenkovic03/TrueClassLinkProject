...
class MessageHistorique: ObservableObject {
    ...
    init() {
        ...
        var messageWithResponse1 = Message(auteur: User(email: "eleve", mdp: "osef", name: "Vache", surname: "Julie"), destinaire: User(email: "prof", mdp: "osef", name: "Perrot", surname: "Amélie"), typeQuestion: .poserQuest, message: "Je voudrais savoir si je peux avoir plus d'éclaircissement sur le dernier point de cours", response: response)
        var messageWithResponse2 = Message(auteur: User(email: "pierre", mdp: "osef", name: "Coupe", surname: "Olga"), destinaire: User(email: "prof", mdp: "osef", name: "Perrot", surname: "Amélie"), typeQuestion: .poserQuest, message: "Je voudrais savoir si je peux avoir plus d'éclaircissement sur le dernier point de cours", response: response2)
        var messageWithResponse3 = Message(auteur: User(email: "eleve", mdp: "osef", name: "Verrin", surname: "Patricia"), destinaire: User(email: "prof", mdp: "osef", name: "Perrot", surname: "Amélie"), typeQuestion: .poserQuest, message: "Je voudrais savoir si je peux avoir plus d'éclaircissement sur le dernier point de cours", response: response3)
